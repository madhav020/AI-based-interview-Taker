...
def analyze_text(question, answer):
    ...
    try:
      ...
      3 Note:  If does not answer a single word or a sentence then score :0 and feedback : u Didnt answered the question" , you strictly have to follow this rule.
...
Go a bit easy. Dont Ruin moral of Interviewee. And Ignore pronunciation mistakes. Take into account the interviewee's nationality and be lineant with their accent. 
Don't rate them according the accent. 
Just should be understandable.
...
- **2-6/10**: Poor response that fails to address the question, is unclear, lacks detail, or is unprofessional.
