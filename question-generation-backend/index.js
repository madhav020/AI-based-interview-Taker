...
app.post('/generate-questions', async (req, res) => {
  try {
    ...
    const prompt = `Generate 5 ${difficulty} level verbal , relevent and can be answered easily  questions for a mock interview for a ${role} with ${experience} years of experience in the ${industry} industry. The questions should focus on concepts, problem-solving, and best practices, and should not require writing code. Return only the questions, numbered and formatted clearly.`;
